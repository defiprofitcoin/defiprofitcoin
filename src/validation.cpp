...
#if defined(NDEBUG)
# error "Defiprofitcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Defiprofitcoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s DPC additional fees, %d delta bytes\n",
...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
    ...
    if(nHeight <= 10)
    {
       nSubsidy = 1700000* COIN; //premine 17,000,000 DPC in 10 blocks
    }
    else if(nHeight <= 43200012)
    {
       nSubsidy = 0.06944444 * COIN; // 2999999.94688888 DPC in next 43200002 blocks
    }  
    else if(nHeight == 72000013)
    {
       nSubsidy = 0.03472222 * COIN; // 999999.97072222 DPC in next 28800001 blocks
    }     
    return nSubsidy;
}
