...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/defiprofitcoin/defiprofitcoin>";
    const std::string URL_WEBSITE = "<https://defiprofitcoin.com>";

    return (strprintf(_("Copyright (C) %i The Defiprofitcoin Core Developers"), COPYRIGHT_YEAR) + " ") +
           "\n" +
           (strprintf(_("Copyright (C) 2011-%i The Litecoin Core Developers"), COPYRIGHT_YEAR) + " ") +
           "\n" +
           strprintf(_("Copyright (C) 2009-%i The Bitcoin Core Developers"), COPYRIGHT_YEAR) + " " + "\n" +
           "\n" +
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Defiprofitcoin version %s\n", FormatFullVersion());
}
