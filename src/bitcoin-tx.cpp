...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s defiprofitcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  defiprofitcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded defiprofitcoin transaction") + "\n" +
              "  defiprofitcoin-tx [options] -create [commands]   " + _("Create hex-encoded defiprofitcoin transaction") + "\n" +
              "\n";
